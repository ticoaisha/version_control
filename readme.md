...
* debug. Commit history helps identify and fix configuration issues or code bugs.
...
Some other resources that you might find helpful to use while learning the above basiscs are: 
